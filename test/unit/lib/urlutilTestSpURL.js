...
describe('urlutil', function () {
  describe('isNotUrl', function () {
    it('Has space inside url', function () {
      assert.equal(urlUtil.isNotURL('https://www.google.ca/search?q=dog cat'), true)
    })
    it('Has space inside URL and head and back', function () {
      assert.equal(urlUtil.isNotURL(' https://www.google.ca/search?q=dog cat '), true)
    })
    it('File path with space inside', function () {
      assert.equal(urlUtil.isNotURL('/Users/kignorc/brave-browser/browser-laptop/dog cat.txt'), true)
    })
